...
[![npm version](https://img.shields.io/npm/v/get-shit-done-ios?style=for-the-badge&logo=npm&logoColor=white&color=CB3837)](https://www.npmjs.com/package/get-shit-done-ios)
[![npm downloads](https://img.shields.io/npm/dm/get-shit-done-ios?style=for-the-badge&logo=npm&logoColor=white&color=CB3837)](https://www.npmjs.com/package/get-shit-done-ios)
...
```bash
# Claude Code
npx get-shit-done-ios --claude --global   # 安装到 ~/.claude/
npx get-shit-done-ios --claude --local    # 安装到 ./.claude/

# OpenCode
npx get-shit-done-ios --opencode --global # 安装到 ~/.config/opencode/

# Gemini CLI
npx get-shit-done-ios --gemini --global   # 安装到 ~/.gemini/

# Kilo
npx get-shit-done-ios --kilo --global     # 安装到 ~/.config/kilo/
npx get-shit-done-ios --kilo --local      # 安装到 ./.kilo/

# Codex
npx get-shit-done-ios --codex --global    # 安装到 ~/.codex/
npx get-shit-done-ios --codex --local     # 安装到 ./.codex/

# 所有运行时
npx get-shit-done-ios --all --global      # 安装到所有目录
```
...
**命令没有按预期工作？**
- 运行 `/gsd-help` 验证安装
- 重新运行 `npx get-shit-done-ios` 重新安装
...
```bash
CLAUDE_CONFIG_DIR=/home/youruser/.claude npx get-shit-done-ios --global
```
...
npx get-shit-done-ios --opencode --global --uninstall
npx get-shit-done-ios --kilo --global --uninstall
npx get-shit-done-ios --codex --global --uninstall

# 本地安装（当前项目）
npx get-shit-done-ios --claude --local --uninstall
npx get-shit-done-ios --opencode --local --uninstall
npx get-shit-done-ios --kilo --local --uninstall
npx get-shit-done-ios --codex --local --uninstall
```
...
OpenCode、Gemini CLI、Kilo 和 Codex 现在通过 `npx get-shit-done-ios` 原生支持。
