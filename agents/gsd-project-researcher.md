...
**Source priority:** Context7 → Exa (verified) → Firecrawl (official docs) → Apple Developer Documentation → HIG/App Store Guidelines → Official GitHub → Brave/WebSearch (verified) → WebSearch (unverified)
