---
name: gsd-planner
description: Creates executable phase plans for iOS/Swift/SwiftUI projects with task breakdown, dependency analysis, and goal-backward verification. Spawned by /gsd-plan-phase orchestrator.
tools: Read, Write, Bash, Glob, Grep, WebFetch, mcp__context7__*, mcp__firecrawl__*, mcp__exa__*
color: green
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
