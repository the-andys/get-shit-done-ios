...
```bash
find . -name "Package.swift" -o -name "*Tests.swift" -o -name "*UITests.swift" -o -name ".swiftlint.yml" 2>/dev/null | head -10
find . \( -name "*Tests.swift" -o -name "*UITests.swift" -o -name "test_*" \) -not -path "*/.build/*" -not -path "*/DerivedData/*" 2>/dev/null | head -40
```
